...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      '  - Internet',
      'License: MIT',
      'WebSite: https://github.com/XyrusCode/video-plucker-mobile-v2',
      'SourceCode: https://github.com/XyrusCode/video-plucker-mobile-v2',
      'IssueTracker: https://github.com/XyrusCode/video-plucker-mobile-v2/issues',
      `AutoName: ${appName}`,
      `Name: ${appName}`,
      ...
      `Repo: https://github.com/XyrusCode/video-plucker-mobile-v2.git`,
      'Build:',
