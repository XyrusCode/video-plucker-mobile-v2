...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      '  - Internet',
      'License: MIT',
      'WebSite: https://gitlab.com/KyriosNyx/video-plucker-mobile-v2',
      'SourceCode: https://gitlab.com/KyriosNyx/video-plucker-mobile-v2',
      'IssueTracker: https://gitlab.com/KyriosNyx/video-plucker-mobile-v2/-/issues',
      `AutoName: ${appName}`,
      `Name: ${appName}`,
      ...
      `Repo: https://gitlab.com/KyriosNyx/video-plucker-mobile-v2.git`,
      'Build:',
