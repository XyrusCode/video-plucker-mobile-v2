...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      '  - Internet',
      'License: MIT',
      'WebSite: https://gitlab.com/XyrusCode/video-plucker-mobile-v2',
      'SourceCode: https://gitlab.com/XyrusCode/video-plucker-mobile-v2',
      'IssueTracker: https://gitlab.com/XyrusCode/video-plucker-mobile-v2/-/issues',
      `AutoName: ${appName}`,
      `Name: ${appName}`,
      ...
      `Repo: https://gitlab.com/XyrusCode/video-plucker-mobile-v2.git`,
      'Build:',
